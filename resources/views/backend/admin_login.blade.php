...
<head>
        ...
        <link rel="stylesheet" href="{{asset('public/css/backend_css/bootstrap-responsive.min')}}" />
    ...
    <body>
        ...
        @endif            
              <form class="form-vertical" role="form" method="POST" action="{{ route('admin.auth.login')}}">{{ csrf_field() }}
                 <div class="control-group normal_text"> <h3>E-commerce Admin</h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input id="email" type="text" name="email" placeholder="Email Address" required="" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
